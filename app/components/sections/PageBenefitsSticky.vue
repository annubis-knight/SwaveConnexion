...
const benefits = computed<Benefit[]>(() => [
  {
    ...
    description: 'La bachata, c\'est avant tout une invitation au lâcher-prise. Ici, pas de performance à atteindre, pas de regard critique. Juste toi, la musique, et cette sensation unique quand ton corps commence à comprendre le rythme. Chaque cours se termine avec le sourire — garanti.',
